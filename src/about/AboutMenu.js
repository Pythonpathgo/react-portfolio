...
export default class AboutMenu extends Component {
  ...
  /*telling the app to make sure to start at the begining 
  of the subheading tab of each*/
constructor(props){
  super(props);
  this.state = {
    activeMenuItem: 1,
...
handleSubheadingClick = (subheading) => {
  ...
  render() {
    /*creating the title buttons in the about pg*/
...
//left side of container for buttons//
    return (
      <>
      <div className="menu"> 
